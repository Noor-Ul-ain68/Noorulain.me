    ...
    for (const post of blogPosts) {
        await prisma.post.upsert({
            ...
            create: {
                title: post.title,
                slug: post.slug,
                content: `<p>${post.excerpt}</p><p>This is a migrated post from the old system. Here we provide insights on <strong>${post.category}</strong>. This content is ready for search engine optimization and dynamic management through your new admin dashboard.</p>`,
