...
export default function BlogPage() {
    ...
    return (
        <>
            {/* HERO */}
            <section className="pt-24 pb-16 relative overflow-hidden tech-grid">
                ...
                <div className="container-custom relative z-10 text-center max-w-3xl mx-auto">
                    ...
                    <h1 className="text-[28px] xs:text-[32px] sm:text-5xl lg:text-7xl font-black text-white mb-4 leading-[1.2] lg:leading-[1.1]">
                        AI Automation{' '}
